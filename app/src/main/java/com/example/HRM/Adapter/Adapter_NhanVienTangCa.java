...
public class Adapter_NhanVienTangCa extends RecyclerView.Adapter<Adapter_NhanVienTangCa.RecyclerViewHolder> {
    ...
    public Adapter_NhanVienTangCa(Context mContext, List<NhanVienTangCa> data) {
        this.data = data;
        temp.addAll(data);
        ...
        if (charText.length() == 0) {
            ...
            for (NhanVienTangCa nhanVienTangCa : temp) {
                if (String.valueOf(nhanVienTangCa.getTennv()).toLowerCase(Locale.getDefault()).contains(charText)
                        ...
                        || String.valueOf(nhanVienTangCa.getNgaytangca()).toLowerCase(Locale.getDefault()).contains(charText)
                ) {
